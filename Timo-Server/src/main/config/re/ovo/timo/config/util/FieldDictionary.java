...
public class FieldDictionary {
    ...
    /**
     * Returns an specific field of some class. If definedIn is null, it searchs for the field named
     * 'name' inside the class cls. If definedIn is different than null, tries to find the specified
     * field name in the specified class cls which should be defined in class definedIn (either
    ...
    private static class FieldKey {
        ...
        public boolean equals(Object o) {
            ...
            if (fieldName != null ? !fieldName.equals(fieldKey.fieldName)
                    : fieldKey.fieldName != null) {
                return false;
            }
