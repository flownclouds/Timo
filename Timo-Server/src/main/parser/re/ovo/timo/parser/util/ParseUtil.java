 ...
 * the License.
 */
package re.ovo.timo.parser.util;
...
public final class ParseUtil {
     ...
     */
    public static int nextStringIsExpectedWithIgnoreSepChar(String stmt, int offset,
            String nextExpectedString, boolean checkSepChar) {
