...
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_BINARY;
...
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_COLUMN;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_DEFAULT;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_EXISTS;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_IF;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_IGNORE;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_INDEX;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_KEY;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_KEYS;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_NOT;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_ON;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_SET;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_TABLE;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_TO;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_UNSIGNED;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_USING;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_ZEROFILL;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.LITERAL_NULL;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.LITERAL_NUM_PURE_DIGIT;
...
import re.ovo.timo.parser.ast.expression.primary.literal.Literal;
