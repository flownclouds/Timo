 ...
 */
package re.ovo.timo.parser.recognizer.mysql.syntax;

import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.EOF;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.IDENTIFIER;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_AND;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_AS;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_ASC;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_BY;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_COLLATE;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_DESC;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_DISTINCT;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_FROM;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_IN;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_INTEGER;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_LIKE;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_NOT;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_SELECT;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_SEPARATOR;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_THEN;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_USING;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_WHEN;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_WITH;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.LITERAL_CHARS;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.OP_ASSIGN;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.PUNC_COMMA;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.PUNC_DOT;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.PUNC_LEFT_PAREN;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.PUNC_RIGHT_PAREN;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.USR_VAR;
...
import re.ovo.timo.parser.ast.expression.arithmeic.ArithmeticAddExpression;
import re.ovo.timo.parser.ast.expression.arithmeic.ArithmeticDivideExpression;
import re.ovo.timo.parser.ast.expression.arithmeic.ArithmeticIntegerDivideExpression;
import re.ovo.timo.parser.ast.expression.arithmeic.ArithmeticModExpression;
import re.ovo.timo.parser.ast.expression.arithmeic.ArithmeticMultiplyExpression;
import re.ovo.timo.parser.ast.expression.arithmeic.ArithmeticSubtractExpression;
import re.ovo.timo.parser.ast.expression.arithmeic.MinusExpression;
import re.ovo.timo.parser.ast.expression.bit.BitAndExpression;
import re.ovo.timo.parser.ast.expression.bit.BitInvertExpression;
import re.ovo.timo.parser.ast.expression.bit.BitOrExpression;
import re.ovo.timo.parser.ast.expression.bit.BitShiftExpression;
import re.ovo.timo.parser.ast.expression.bit.BitXORExpression;
...
import re.ovo.timo.parser.ast.expression.comparison.ComparisionGreaterThanExpression;
import re.ovo.timo.parser.ast.expression.comparison.ComparisionGreaterThanOrEqualsExpression;
import re.ovo.timo.parser.ast.expression.comparison.ComparisionIsExpression;
import re.ovo.timo.parser.ast.expression.comparison.ComparisionLessOrGreaterThanExpression;
import re.ovo.timo.parser.ast.expression.comparison.ComparisionLessThanExpression;
import re.ovo.timo.parser.ast.expression.comparison.ComparisionLessThanOrEqualsExpression;
import re.ovo.timo.parser.ast.expression.comparison.ComparisionNotEqualsExpression;
...
import re.ovo.timo.parser.ast.expression.logical.LogicalNotExpression;
import re.ovo.timo.parser.ast.expression.logical.LogicalOrExpression;
import re.ovo.timo.parser.ast.expression.logical.LogicalXORExpression;
import re.ovo.timo.parser.ast.expression.logical.NegativeValueExpression;
import re.ovo.timo.parser.ast.expression.misc.AssignmentExpression;
...
import re.ovo.timo.parser.ast.expression.misc.SubqueryAllExpression;
import re.ovo.timo.parser.ast.expression.misc.SubqueryAnyExpression;
...
import re.ovo.timo.parser.ast.expression.primary.Wildcard;
import re.ovo.timo.parser.ast.expression.primary.MatchExpression.Modifier;
...
import re.ovo.timo.parser.ast.expression.primary.function.string.Trim.Direction;
...
import re.ovo.timo.parser.ast.expression.string.RegexpExpression;
import re.ovo.timo.parser.ast.expression.string.SoundsLikeExpression;
import re.ovo.timo.parser.ast.expression.type.CastBinaryExpression;
    ...
    private Expression primaryExpression(final String consumed, String consumedUp)
        ...
        switch (lexer.token()) {
            ...
            case LITERAL_NCHARS:
                ...
                return new LiteralString(null, tempSb.toString(), true)
                        .setCacheEvalRst(cacheEvalRst);
            case LITERAL_CHARS:
                tempSb = new StringBuilder();
                do {
                ...
                return new LiteralString(null, tempSb.toString(), false)
                        .setCacheEvalRst(cacheEvalRst);
    ...
    private Expression startedFromIdentifier(final String consumed, String consumedUp)
        ...
        switch (lexer.token()) {
            ...
            case LITERAL_CHARS:
                ...
                return new LiteralString(consumed, tempSb.toString(), false)
                        .setCacheEvalRst(cacheEvalRst);
            case PUNC_LEFT_PAREN:
