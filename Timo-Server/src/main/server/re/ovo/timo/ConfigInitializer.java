...
import re.ovo.timo.config.loader.xml.XMLConfigLoader;
...
public class ConfigInitializer {
    ...
    public ConfigInitializer() {
        ...
        this.cluster = initTimoCluster(configLoader);
        ...
        for (UserConfig uc : users.values()) {
            ...
            for (String schema : authSchemas) {
                if (!schemas.containsKey(schema)) {
                    String errMsg =
                            "schema " + schema + " refered by user " + uc.getName()
                                    + " is not exist!";
    ...
    private TimoCluster initTimoCluster(ConfigLoader configLoader) {
        return new TimoCluster(configLoader.getClusterConfig());
    }
