...
import re.ovo.timo.route.function.PartitionByString;
...
public class PartitionByStringTest extends TestCase {
    ...
    public void testPartition() {
        PartitionByString sut =
                new PartitionByString("test   ",
                        (List<Expression>) ListUtil.createList(new PlaceHolder("member_id",
