...
import re.ovo.timo.parser.ast.fragment.SortOrder;
...
import re.ovo.timo.parser.recognizer.mysql.syntax.MySQLDMLParser;
import re.ovo.timo.parser.recognizer.mysql.syntax.MySQLDMLSelectParser;
import re.ovo.timo.parser.recognizer.mysql.syntax.MySQLExprParser;
import re.ovo.timo.parser.util.ListUtil;
...
public class MySQLDMLParserTest extends AbstractSyntaxTest {
    ...
    public void testOrderBy() throws SQLSyntaxErrorException {
        ...
        ListUtil.isEquals(ListUtil.createList(new Pair<Expression, SortOrder>(new Identifier(null,
                "c1"), SortOrder.ASC), new Pair<Expression, SortOrder>(new Identifier(null, "c2"),
                SortOrder.DESC), new Pair<Expression, SortOrder>(new Identifier(null, "c3"),
                SortOrder.ASC)), orderBy.getOrderByList());
        ...
        ListUtil.isEquals(ListUtil.createList(new Pair<Expression, SortOrder>(new Identifier(null,
                "c1"), SortOrder.ASC)), orderBy.getOrderByList());
        ...
        output = output2MySQL(orderBy, sql);
        ListUtil.isEquals(ListUtil.createList(new Pair<Expression, SortOrder>(new Identifier(null,
                "c1"), SortOrder.DESC)), orderBy.getOrderByList());
    ...
    public void testGroupBy() throws SQLSyntaxErrorException {
        ...
        ListUtil.isEquals(ListUtil.createList(new Pair<Expression, SortOrder>(new Identifier(null,
                "c1"), SortOrder.ASC), new Pair<Expression, SortOrder>(new Identifier(null, "c2"),
                SortOrder.DESC), new Pair<Expression, SortOrder>(new Identifier(null, "c3"),
                SortOrder.ASC)), groupBy.getOrderByList());
        ...
        output = output2MySQL(groupBy, sql);
        ListUtil.isEquals(ListUtil.createList(new Pair<Expression, SortOrder>(new Identifier(null,
                "c1"), SortOrder.ASC)), groupBy.getOrderByList());
        ...
        output = output2MySQL(groupBy, sql);
        ListUtil.isEquals(ListUtil.createList(new Pair<Expression, SortOrder>(new Identifier(null,
                "c1"), SortOrder.DESC)), groupBy.getOrderByList());
    ...
    public void testTR1() throws SQLSyntaxErrorException {
        ...
        Assert.assertEquals(1, list.size());
        Assert.assertEquals(TableRefFactor.class, list.get(0).getClass());
        List<IndexHint> hintlist =
                ((TableRefFactor) (trs.getTableReferenceList()).get(0)).getHintList();
        ...
        Assert.assertEquals(1, list.size());
        Assert.assertEquals(TableRefFactor.class, list.get(0).getClass());
        Assert.assertEquals("tb1", ((TableRefFactor) (trs.getTableReferenceList()).get(0))
                .getTable().getIdText());
        ...
        Assert.assertEquals(null,
                ((TableRefFactor) (trs.getTableReferenceList()).get(0)).getAlias());
        Assert.assertEquals("tb2", ((TableRefFactor) (trs.getTableReferenceList()).get(1))
                .getTable().getIdText());
        Assert.assertEquals("tb3", ((TableRefFactor) (trs.getTableReferenceList()).get(2))
                .getTable().getIdText());
        ...
        sql =
                "tb1 use key for order by (i1,i2) use key for group by () "
        ...
        Assert.assertEquals("INDEX", indexhint.getType().name());
        Assert.assertEquals("GROUP_BY", indexhint.getScope().name());
        Assert.assertEquals("tb1 USE INDEX FOR ORDER BY (i1, i2) FORCE INDEX FOR GROUP BY (i1)",
                output);
        ...
        sql =
                "(tb1 force index for join (i1,i2) )left outer join tb2 as t2 "
        ...
        Assert.assertEquals(null,
                ((TableRefFactor) (ltr.getTableReferenceList().get(0))).getAlias());
        Assert.assertEquals("tb1", ((TableRefFactor) (ltr.getTableReferenceList().get(0)))
                .getTable().getIdText());
        ...
        Assert.assertEquals(ComparisionEqualsExpression.class, ((OuterJoin) list.get(0))
                .getOnCond().getClass());
        ...
        Assert.assertEquals(null,
                ((TableRefFactor) (ltr2.getTableReferenceList().get(0))).getAlias());
        Assert.assertEquals("tb1", ((TableRefFactor) (ltr2.getTableReferenceList().get(0)))
                .getTable().getIdText());
        ...
        Assert.assertEquals("tb3", ((TableRefFactor) (ltr2.getTableReferenceList().get(1)))
                .getTable().getIdText());
        Assert.assertEquals(TableRefFactor.class, ltr1.getTableReferenceList().get(1).getClass());
        Assert.assertEquals("tb4", ((TableRefFactor) (ltr1.getTableReferenceList().get(1)))
                .getTable().getIdText());
        Assert.assertEquals(TableRefFactor.class, ltr.getTableReferenceList().get(1).getClass());
        Assert.assertEquals("tb5", ((TableRefFactor) (ltr.getTableReferenceList().get(1)))
                .getTable().getIdText());
        ...
        Assert.assertEquals("tb2", ((TableRefFactor) rtr.getTableReferenceList().get(0)).getTable()
                .getIdText());
        ...
        Assert.assertEquals("ALL", indexhint.getScope().name());
        Assert.assertEquals("tb2", rtf.getTable().getIdText());
        Assert.assertEquals("(SELECT '  @  from' FROM `from`) AS T1 "
                + "INNER JOIN tb2 AS T2 USE INDEX ()", output);
        ...
        Assert.assertEquals(1, ltr.getTableReferenceList().size());
        TableRefFactor lltrf =
                (TableRefFactor) ((OuterJoin) ltr.getTableReferenceList().get(0)).getLeftTableRef();
        ...
        Assert.assertEquals(LogicalAndExpression.class, ((InnerJoin) list.get(0)).getOnCond()
                .getClass());
        Assert.assertEquals("(tb1 RIGHT JOIN tb2 USING ()) "
                + "INNER JOIN tb3 ON tb1.id = tb2.id AND tb2.id = tb3.id", output);

        sql =
                "tb1 right outer join tb2 using(id1,id2) "
                        + "join (tb3,tb4) on tb1.id=tb2.id and tb2.id=tb3.id";
        lexer = new MySQLLexer(sql);
        parser = getDMLParser(lexer);
        trs = parser.tableRefs();
        output = output2MySQL(trs, sql);
        ...
        Assert.assertEquals("tb3", ((TableRefFactor) (rtr.getTableReferenceList().get(0)))
                .getTable().getIdText());
        Assert.assertEquals("tb4", ((TableRefFactor) (rtr.getTableReferenceList().get(1)))
                .getTable().getIdText());
        Assert.assertEquals(LogicalAndExpression.class, ((InnerJoin) list.get(0)).getOnCond()
                .getClass());
        ...
        sql =
                "(select (select * from tb1) from `select` "
        ...
        sql =
                "((tb1),(tb3 as t3,`select`),tb2 use key for join (i1,i2))"
        ...
        Assert.assertEquals(1, list.size());
        Assert.assertEquals(OuterJoin.class, list.get(0).getClass());
        Assert.assertEquals(TableReferences.class, ((OuterJoin) list.get(0)).getLeftTableRef()
                .getClass());
        Assert.assertEquals(InnerJoin.class, ((OuterJoin) list.get(0)).getRightTableRef()
                .getClass());
        list =
                ((TableReferences) ((OuterJoin) list.get(0)).getLeftTableRef())
        ...
        sql =
                "((select `select` from `from` ) tb1),(tb3 as t3,`select`),tb2 use key for join (i1,i2) "
        ...
        Assert.assertEquals(1, using_list.size());
        Assert.assertEquals(InnerJoin.class, ((OuterJoin) (list.get(0))).getLeftTableRef()
                .getClass());
        Assert.assertEquals(StraightJoin.class, ((OuterJoin) (list.get(0))).getRightTableRef()
                .getClass());
