...
public class MySQLDMLUpdateParserTest extends AbstractSyntaxTest {
    ...
    public void testUpdate() throws SQLSyntaxErrorException {
        ...
        Assert.assertEquals("UPDATE LOW_PRIORITY IGNORE test.t1 SET t1.col1 = ?, col2 = DEFAULT",
                output);
        ...
        update = parser.update();
        output = output2MySQL(update, sql);
        Assert.assertEquals("UPDATE LOW_PRIORITY t1, test.t2 SET col2 = DEFAULT, col2 = '123\\'4'",
                output);
