...
import re.ovo.timo.parser.ast.fragment.VariableScope;
...
public class MySQLExprParserTest extends AbstractSyntaxTest {
    ...
    public void testExpr1() throws Exception {
        ...
        BinaryOperatorExpression bex =
                (BinaryOperatorExpression) ((ArithmeticAddExpression) expr).getRightOprand();
        ...
        TernaryOperatorExpression tex =
                (TernaryOperatorExpression) ((LogicalNotExpression) expr).getOperand();
    ...
    public void testLogical() throws Exception {
        ...
        LogicalNotExpression not =
                (LogicalNotExpression) ((LogicalNotExpression) expr).getOperand();
    ...
    public void testComparision() throws Exception {
        ...
        ComparisionLessOrGreaterThanExpression lg =
                (ComparisionLessOrGreaterThanExpression) neq.getLeftOprand();
        ComparisionLessThanExpression l = (ComparisionLessThanExpression) lg.getLeftOprand();
        ComparisionLessThanOrEqualsExpression leq =
                (ComparisionLessThanOrEqualsExpression) l.getLeftOprand();
        ComparisionGreaterThanExpression g = (ComparisionGreaterThanExpression) leq.getLeftOprand();
        ComparisionGreaterThanOrEqualsExpression geq =
                (ComparisionGreaterThanOrEqualsExpression) g.getLeftOprand();
        ComparisionNullSafeEqualsExpression nseq =
                (ComparisionNullSafeEqualsExpression) geq.getLeftOprand();
    ...
    public void testArithmetic() throws Exception {
        ...
        ArithmeticIntegerDivideExpression idiv =
                (ArithmeticIntegerDivideExpression) sub.getRightOprand();
    ...
    public void testAnyAll() throws Exception {
        ...
        ComparisionGreaterThanOrEqualsExpression ge =
                (ComparisionGreaterThanOrEqualsExpression) gt.getLeftOprand();
    ...
    public void testInterval() throws Exception {
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("DATE_SUB('2005-01-01 00:00:00', INTERVAL '1 1:1:1' DAY_SECOND)",
                output);
        ...
        output = output2MySQL(expr, sql);
        Assert.assertEquals(
                "DATE_ADD('1992-12-31 23:59:59.000002', INTERVAL '1:1.999999' MINUTE_MICROSECOND)",
                output);
        ...
        output = output2MySQL(expr, sql);
        Assert.assertEquals(
                "DATE_ADD('1992-12-31 23:59:59.000002', INTERVAL '1:1:1.999999' HOUR_MICROSECOND)",
                output);
        ...
        output = output2MySQL(expr, sql);
        Assert.assertEquals(
                "DATE_ADD('1992-12-31 23:59:59.000002', INTERVAL '1 1:1:1.999999' DAY_MICROSECOND)",
                output);
    ...
    public void testMatchExpression() throws Exception {
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("MATCH (col1, col2, col3) AGAINST (a := b := c IN BOOLEAN MODE)",
                output);
        ...
        expr = parser.expression();
        output = output2MySQL(expr, sql);
        Assert.assertEquals("MATCH (title, body) AGAINST (a BETWEEN b AND c IN BOOLEAN MODE)",
                output);
        ...
        output = output2MySQL(expr, sql);
        Assert.assertEquals(
                "MATCH (title, body) AGAINST ((a BETWEEN b AND abc IN (d)) IN BOOLEAN MODE)",
                output);
