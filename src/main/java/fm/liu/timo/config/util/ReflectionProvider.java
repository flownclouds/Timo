...
public class ReflectionProvider {
    ...
    public void visitSerializableFields(Object object, Visitor visitor) {
        for (Iterator<Field> iterator =
                fieldDictionary.serializableFieldsFor(object.getClass()); iterator.hasNext();) {
            ...
            try {
                ...
                throw new ObjectAccessException(
                        "Could not get field " + field.getClass() + "." + field.getName(), e);
            } catch (IllegalAccessException e) {
                throw new ObjectAccessException(
                        "Could not get field " + field.getClass() + "." + field.getName(), e);
            }
    ...
    public void invokeMethod(Object object, String methodName, Object value, Class<?> definedIn) {
        try {
            ...
            throw new ObjectAccessException(
                    "Could not invoke " + object.getClass() + "." + methodName, e);
        }
    }
    ...
    private Object instantiateUsingSerialization(Class<?> type) {
        try {
            ...
            throw new ObjectAccessException(
                    "Cannot create " + type.getName() + " by JDK serialization", e);
