...
public final class PartitionOperandHintParser extends HintParser {
    ...
    @Override
    public void process(TimoHint hint, String hintName, String sql) throws SQLSyntaxErrorException {
        String[] columns;
     ...
     */
    private Object[] parseArray(TimoHint hint, String sql, int len) throws SQLSyntaxErrorException {
        Object[] rst = null;
     ...
     */
    private Object[][] parseArrayArray(TimoHint hint, String sql, int columnNum)
            ...
            for (;;) {
                ...
                switch (c) {
                    ...
                    case ',':
                        ...
                        break;
                    default:
                        throw new SQLSyntaxErrorException("err for partitionOperand array[]: "
                                + sql);
                }
            }
        } else {
