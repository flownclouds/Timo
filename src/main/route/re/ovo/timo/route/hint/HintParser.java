...
public abstract class HintParser {
    ...
    /**
     * hint's {@link TimoHint#getCurrentIndex()} will be changed to index of next char after process
     */
    public abstract void process(TimoHint hint, String hintName, String sql)
            throws SQLSyntaxErrorException;

    private void skipSpace(TimoHint hint, String sql) {
    ...
    protected char currentChar(TimoHint hint, String sql) {
        skipSpace(hint, sql);
     ...
     */
    protected char nextChar(TimoHint hint, String sql) {
        skipSpace(hint, sql);
        skipSpace(hint.increaseCurrentIndex(), sql);
        return sql.charAt(hint.getCurrentIndex());
    }

    protected Object parsePrimary(TimoHint hint, String sql) throws SQLSyntaxErrorException {
