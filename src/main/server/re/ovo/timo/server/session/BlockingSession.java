...
import re.ovo.timo.mysql.bio.executor.DefaultCommitExecutor;
import re.ovo.timo.mysql.bio.executor.MultiNodeExecutor;
import re.ovo.timo.mysql.bio.executor.NodeExecutor;
import re.ovo.timo.mysql.bio.executor.RollbackExecutor;
import re.ovo.timo.mysql.bio.executor.SingleNodeExecutor;
...
public class BlockingSession implements Session {
     ...
     * 
     * @param pessimisticRelease true if this method might be invoked concurrently with
     *        {@link #kill()}
     */
