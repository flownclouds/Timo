 ...
 * the License.
 */
package re.ovo.timo.config.loader;
...
import re.ovo.timo.config.model.Rule;
import re.ovo.timo.config.model.Table;
import re.ovo.timo.config.model.User;
import re.ovo.timo.route.function.AutoFunction;
import re.ovo.timo.route.function.HashFunction;
import re.ovo.timo.route.function.MatchFunction;
import re.ovo.timo.route.function.Range;
import re.ovo.timo.route.function.RangeFunction;
    ...
    private void loadDatasources(Connection con) throws SQLException {
        ...
        while (result.next()) {
            ...
            Datasource datasource =
                    new Datasource(id, datanodeID, host, port, username, password, db, type,
                            status, charset, initCon, maxCon, minIdle, maxIdle, idleCheckPeriod);
