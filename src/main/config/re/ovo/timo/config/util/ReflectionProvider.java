...
public class ReflectionProvider {
    ...
    public void visitSerializableFields(Object object, Visitor visitor) {
        for (Iterator<Field> iterator = fieldDictionary.serializableFieldsFor(object.getClass()); iterator
                .hasNext();) {
    ...
    public void writeField(Object object, String fieldName, Object value, Class<?> definedIn) {
        ...
        try {
            ...
            throw new ObjectAccessException("Could not set field " + field.getName() + "@"
                    + object.getClass(), e);
        } catch (IllegalAccessException e) {
            throw new ObjectAccessException("Could not set field " + field.getName() + "@"
                    + object.getClass(), e);
    ...
    public void invokeMethod(Object object, String methodName, Object value, Class<?> definedIn) {
        try {
            ...
            throw new ObjectAccessException("Could not invoke " + object.getClass() + "."
                    + methodName, e);
        }
    }
    ...
    private boolean fieldModifiersSupported(Field field) {
        return !(Modifier.isStatic(field.getModifiers()) || Modifier.isTransient(field
                .getModifiers()));
    }
