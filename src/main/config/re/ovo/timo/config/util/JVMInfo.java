 ...
 * the License.
 */
package re.ovo.timo.config.util;
...
public class JVMInfo {
    ...
    private static final float majorJavaVersion = getMajorJavaVersion(System
    ...
    /*
     * Support for sun.misc.Unsafe and sun.reflect.ReflectionFactory is present in JRockit versions
     * R25.1.0 and later, both 1.4.2 and 5.0 (and in future 6.0 builds).
     */
    private static boolean isBEAWithUnsafeSupport() {
        ...
        if (System.getProperty("java.vm.vendor").indexOf("BEA") != -1) {
            ...
            /*
             * Recent 1.4.2 and 5.0 versions of JRockit have a java.vm.version string starting with
             * the "R" JVM version number, i.e. "R26.2.0-38-57237-1.5.0_06-20060209..."
             */
            String vmVersion = System.getProperty("java.vm.version");
            if (vmVersion.startsWith("R")) {
                /*
                 * Wecould also check that it's R26 or later, but that is implicitly true
                 */
                return true;
            }

            /*
             * For older JRockit versions we can check java.vm.info. JRockit 1.4.2 R24 ->
             * "Native Threads, GC strategy: parallel" and JRockit 5.0 R25 -> "R25.2.0-28".
             */
    ...
    protected boolean canUseSun14ReflectionProvider() {
        return (isSun() || isApple() || isHPUX() || isIBM() || isBlackdown() || isBEAWithUnsafeSupport())
