...
public class ParameterMapping {
    ...
    public static Object createBean(BeanConfig config) throws IllegalAccessException,
    ...
    private static boolean isPrimitiveType(Class<?> cls) {
        if (cls.equals(String.class) || cls.equals(Boolean.TYPE) || cls.equals(Byte.TYPE)
                ...
                || cls.equals(Double.TYPE) || cls.equals(Float.TYPE) || cls.equals(Boolean.class)
