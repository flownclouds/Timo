...
public class Identifier extends PrimaryExpression implements Cloneable {
    ...
    /**
     * @param level At most how many levels left after trim, must be a positive integer. e.g. level
     *        = 2 for "schema1.tb1.c1", "tb1.c1" is left
     * @param trimSchema upper-case. Assumed that top trimmed parent is schema, if that equals given
     *        schema, do not trim
