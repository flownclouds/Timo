 ...
 */
package fm.liu.timo.parser.recognizer.mysql;
...
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Acos;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Asin;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Atan;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Atan2;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Ceiling;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Conv;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Cos;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Cot;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Crc32;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Degrees;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Exp;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Floor;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Log;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Log10;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Log2;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Oct;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Pi;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Pow;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Radians;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Rand;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Round;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Sign;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Sin;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Sqrt;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Tan;
import fm.liu.timo.parser.ast.expression.primary.function.arithmetic.Truncate;
import fm.liu.timo.parser.ast.expression.primary.function.bit.BitCount;
import fm.liu.timo.parser.ast.expression.primary.function.comparison.Coalesce;
import fm.liu.timo.parser.ast.expression.primary.function.comparison.Greatest;
import fm.liu.timo.parser.ast.expression.primary.function.comparison.Interval;
import fm.liu.timo.parser.ast.expression.primary.function.comparison.Isnull;
import fm.liu.timo.parser.ast.expression.primary.function.comparison.Least;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Adddate;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Addtime;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.ConvertTz;
...
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Date;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.DateAdd;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.DateFormat;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.DateSub;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Datediff;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Dayname;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Dayofmonth;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Dayofweek;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Dayofyear;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.FromDays;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.FromUnixtime;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Hour;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.LastDay;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Makedate;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Maketime;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Microsecond;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Minute;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Month;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Monthname;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Now;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.PeriodAdd;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.PeriodDiff;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Quarter;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.SecToTime;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Second;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.StrToDate;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Subdate;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Subtime;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Sysdate;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Time;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.TimeFormat;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.TimeToSec;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Timediff;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Timestamp;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.ToDays;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.ToSeconds;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.UnixTimestamp;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.UtcDate;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.UtcTime;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.UtcTimestamp;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Week;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Weekday;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Weekofyear;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Year;
import fm.liu.timo.parser.ast.expression.primary.function.datetime.Yearweek;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.AesDecrypt;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.AesEncrypt;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.Compress;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.Decode;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.DesDecrypt;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.DesEncrypt;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.Encode;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.Encrypt;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.Md5;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.OldPassword;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.Password;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.Sha1;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.Sha2;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.Uncompress;
import fm.liu.timo.parser.ast.expression.primary.function.encryption.UncompressedLength;
import fm.liu.timo.parser.ast.expression.primary.function.flowctrl.If;
import fm.liu.timo.parser.ast.expression.primary.function.flowctrl.Ifnull;
import fm.liu.timo.parser.ast.expression.primary.function.flowctrl.Nullif;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.BitAnd;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.BitOr;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.BitXor;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.Std;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.Stddev;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.StddevPop;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.StddevSamp;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.VarPop;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.VarSamp;
import fm.liu.timo.parser.ast.expression.primary.function.groupby.Variance;
import fm.liu.timo.parser.ast.expression.primary.function.info.Benchmark;
import fm.liu.timo.parser.ast.expression.primary.function.info.Charset;
import fm.liu.timo.parser.ast.expression.primary.function.info.Coercibility;
import fm.liu.timo.parser.ast.expression.primary.function.info.Collation;
import fm.liu.timo.parser.ast.expression.primary.function.info.ConnectionId;
import fm.liu.timo.parser.ast.expression.primary.function.info.CurrentUser;
import fm.liu.timo.parser.ast.expression.primary.function.info.Database;
import fm.liu.timo.parser.ast.expression.primary.function.info.FoundRows;
import fm.liu.timo.parser.ast.expression.primary.function.info.LastInsertId;
import fm.liu.timo.parser.ast.expression.primary.function.info.RowCount;
import fm.liu.timo.parser.ast.expression.primary.function.info.User;
import fm.liu.timo.parser.ast.expression.primary.function.info.Version;
import fm.liu.timo.parser.ast.expression.primary.function.misc.Analyse;
import fm.liu.timo.parser.ast.expression.primary.function.misc.Default;
import fm.liu.timo.parser.ast.expression.primary.function.misc.GetLock;
import fm.liu.timo.parser.ast.expression.primary.function.misc.InetAton;
import fm.liu.timo.parser.ast.expression.primary.function.misc.InetNtoa;
import fm.liu.timo.parser.ast.expression.primary.function.misc.IsFreeLock;
import fm.liu.timo.parser.ast.expression.primary.function.misc.IsUsedLock;
import fm.liu.timo.parser.ast.expression.primary.function.misc.MasterPosWait;
import fm.liu.timo.parser.ast.expression.primary.function.misc.NameConst;
import fm.liu.timo.parser.ast.expression.primary.function.misc.ReleaseLock;
import fm.liu.timo.parser.ast.expression.primary.function.misc.Sleep;
import fm.liu.timo.parser.ast.expression.primary.function.misc.Uuid;
import fm.liu.timo.parser.ast.expression.primary.function.misc.UuidShort;
import fm.liu.timo.parser.ast.expression.primary.function.misc.Values;
import fm.liu.timo.parser.ast.expression.primary.function.string.Ascii;
import fm.liu.timo.parser.ast.expression.primary.function.string.Bin;
import fm.liu.timo.parser.ast.expression.primary.function.string.BitLength;
import fm.liu.timo.parser.ast.expression.primary.function.string.CharLength;
import fm.liu.timo.parser.ast.expression.primary.function.string.Concat;
import fm.liu.timo.parser.ast.expression.primary.function.string.ConcatWs;
import fm.liu.timo.parser.ast.expression.primary.function.string.Elt;
import fm.liu.timo.parser.ast.expression.primary.function.string.ExportSet;
import fm.liu.timo.parser.ast.expression.primary.function.string.Field;
import fm.liu.timo.parser.ast.expression.primary.function.string.FindInSet;
import fm.liu.timo.parser.ast.expression.primary.function.string.Format;
import fm.liu.timo.parser.ast.expression.primary.function.string.Hex;
import fm.liu.timo.parser.ast.expression.primary.function.string.Insert;
import fm.liu.timo.parser.ast.expression.primary.function.string.Instr;
import fm.liu.timo.parser.ast.expression.primary.function.string.Left;
import fm.liu.timo.parser.ast.expression.primary.function.string.Length;
import fm.liu.timo.parser.ast.expression.primary.function.string.LoadFile;
import fm.liu.timo.parser.ast.expression.primary.function.string.Locate;
import fm.liu.timo.parser.ast.expression.primary.function.string.Lower;
import fm.liu.timo.parser.ast.expression.primary.function.string.Lpad;
import fm.liu.timo.parser.ast.expression.primary.function.string.Ltrim;
import fm.liu.timo.parser.ast.expression.primary.function.string.MakeSet;
import fm.liu.timo.parser.ast.expression.primary.function.string.Ord;
import fm.liu.timo.parser.ast.expression.primary.function.string.Quote;
import fm.liu.timo.parser.ast.expression.primary.function.string.Repeat;
import fm.liu.timo.parser.ast.expression.primary.function.string.Replace;
import fm.liu.timo.parser.ast.expression.primary.function.string.Reverse;
import fm.liu.timo.parser.ast.expression.primary.function.string.Right;
import fm.liu.timo.parser.ast.expression.primary.function.string.Rpad;
import fm.liu.timo.parser.ast.expression.primary.function.string.Rtrim;
import fm.liu.timo.parser.ast.expression.primary.function.string.Soundex;
import fm.liu.timo.parser.ast.expression.primary.function.string.Space;
import fm.liu.timo.parser.ast.expression.primary.function.string.Strcmp;
import fm.liu.timo.parser.ast.expression.primary.function.string.Substring;
import fm.liu.timo.parser.ast.expression.primary.function.string.SubstringIndex;
import fm.liu.timo.parser.ast.expression.primary.function.string.Unhex;
import fm.liu.timo.parser.ast.expression.primary.function.string.Upper;
import fm.liu.timo.parser.ast.expression.primary.function.xml.Extractvalue;
import fm.liu.timo.parser.ast.expression.primary.function.xml.Updatexml;
