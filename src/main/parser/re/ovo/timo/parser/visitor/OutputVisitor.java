...
import static re.ovo.timo.parser.ast.expression.comparison.ComparisionIsExpression.IS_FALSE;
import static re.ovo.timo.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_FALSE;
import static re.ovo.timo.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_NULL;
import static re.ovo.timo.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_TRUE;
import static re.ovo.timo.parser.ast.expression.comparison.ComparisionIsExpression.IS_NOT_UNKNOWN;
import static re.ovo.timo.parser.ast.expression.comparison.ComparisionIsExpression.IS_NULL;
import static re.ovo.timo.parser.ast.expression.comparison.ComparisionIsExpression.IS_TRUE;
import static re.ovo.timo.parser.ast.expression.comparison.ComparisionIsExpression.IS_UNKNOWN;
