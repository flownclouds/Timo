...
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_CHARACTER;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_COLLATE;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_DEFAULT;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_DESC;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_DESCRIBE;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_FOR;
...
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_LIMIT;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_OPTION;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_READ;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_SET;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_SHOW;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.KW_WHERE;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.OP_ASSIGN;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.OP_ASTERISK;
import static re.ovo.timo.parser.recognizer.mysql.MySQLToken.OP_EQUALS;
...
import re.ovo.timo.parser.ast.expression.primary.VariableExpression;
...
public class MySQLDALParser extends MySQLParser {
    ...
    private static enum SpecialIdentifier {
        AUTHORS, BINLOG, BLOCK, CODE, COLLATION, COLUMNS, COMMITTED, CONTEXT, CONTRIBUTORS, COUNT, CPU, ENGINE, ENGINES, ERRORS, EVENT, EVENTS, FULL, FUNCTION, GLOBAL, GRANTS, HOSTS, INDEXES, INNODB, IPC, LOCAL, MASTER, MEMORY, MUTEX, NAMES, OPEN, PAGE, PERFORMANCE_SCHEMA, PLUGINS, PRIVILEGES, PROCESSLIST, PROFILE, PROFILES, REPEATABLE, SERIALIZABLE, SESSION, SLAVE, SOURCE, STATUS, STORAGE, SWAPS, TABLES, TRANSACTION, TRIGGERS, UNCOMMITTED, VARIABLES, VIEW, WARNINGS
    }
