...
public class MySQLDMLParserTest extends AbstractSyntaxTest {
    ...
    public void testOrderBy() throws SQLSyntaxErrorException {
        ...
        ListUtil.isEquals(ListUtil.createList(
                new Pair<Expression, SortOrder>(new Identifier(null, "c1"), SortOrder.DESC)),
                orderBy.getOrderByList());
    ...
    public void testTR1() throws SQLSyntaxErrorException {
        ...
        Assert.assertEquals("tb2",
                ((TableRefFactor) (trs.getTableReferenceList()).get(1)).getTable().getIdText());
        Assert.assertEquals("tb3",
                ((TableRefFactor) (trs.getTableReferenceList()).get(2)).getTable().getIdText());
        ...
        Assert.assertEquals("tb1",
                ((TableRefFactor) (ltr.getTableReferenceList().get(0))).getTable().getIdText());
        ...
        Assert.assertEquals("tb1",
                ((TableRefFactor) (ltr2.getTableReferenceList().get(0))).getTable().getIdText());
        ...
        Assert.assertEquals("tb3",
                ((TableRefFactor) (ltr2.getTableReferenceList().get(1))).getTable().getIdText());
        Assert.assertEquals(TableRefFactor.class, ltr1.getTableReferenceList().get(1).getClass());
        Assert.assertEquals("tb4",
                ((TableRefFactor) (ltr1.getTableReferenceList().get(1))).getTable().getIdText());
        ...
        Assert.assertEquals(LogicalAndExpression.class,
                ((InnerJoin) list.get(0)).getOnCond().getClass());
        ...
        Assert.assertEquals("tb3",
                ((TableRefFactor) (rtr.getTableReferenceList().get(0))).getTable().getIdText());
        Assert.assertEquals("tb4",
                ((TableRefFactor) (rtr.getTableReferenceList().get(1))).getTable().getIdText());
        Assert.assertEquals(LogicalAndExpression.class,
                ((InnerJoin) list.get(0)).getOnCond().getClass());
        ...
        Assert.assertEquals(1, list.size());
        Assert.assertEquals(OuterJoin.class, list.get(0).getClass());
        Assert.assertEquals(TableReferences.class,
                ((OuterJoin) list.get(0)).getLeftTableRef().getClass());
        Assert.assertEquals(InnerJoin.class,
                ((OuterJoin) list.get(0)).getRightTableRef().getClass());
        list = ((TableReferences) ((OuterJoin) list.get(0)).getLeftTableRef())
        ...
        Assert.assertEquals(InnerJoin.class,
                ((OuterJoin) (list.get(0))).getLeftTableRef().getClass());
        Assert.assertEquals(StraightJoin.class,
                ((OuterJoin) (list.get(0))).getRightTableRef().getClass());
